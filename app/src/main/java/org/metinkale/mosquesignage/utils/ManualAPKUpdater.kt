...
class ManualAPKUpdater(private var context: Context) {
        ...
        if (jsonData != null) {
            ...
            if (newVersionCode > currentVersionCode) {
                ...
                DownloadNewVersion(
                    ...
                    apkUrl,
                    apkUrl.substringAfterLast("/")
                ).execute()
            } else {
                Toast.makeText(context, "Version up-to-date", Toast.LENGTH_SHORT).show()
            }
        } else {
    ...
    private class DownloadNewVersion(
        ...
        override fun doInBackground(vararg p0: String?): Boolean {
            ...
            try {
                ...
                Log.e("DownloadApk", "Download Failed: " + e.message, e)
            }
